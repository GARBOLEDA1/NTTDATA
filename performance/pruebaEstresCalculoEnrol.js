...
export const options = {
  ...
  thresholds: {
    "http_req_duration": ["avg <= 30000"],//http req duration con percentil o con que average, duración máxima
    "iterations": ["rate >= 0.68"], //Corresponde a TPS testing 3 años lo que me da la matriz
    "http_req_failed": ["rate <= 0.2"],//comparar con http failed
  },
};
